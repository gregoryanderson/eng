...
RSpec.describe 'As a visitor', type: :request do
  before(:each) do
    ...
    @customer_2 = Customer.create(first_name: "Bob", last_name: "Conklin", id: 2)
    @customer_3 = Customer.create(first_name: "Carl", last_name: "Conklin", id: 3)
    ...
    @invoice_3 = Invoice.create(merchant_id: 1, customer_id: 3, id: 3, status: "shipped")
    @invoice_item_1 = InvoiceItem.create(item_id: 1, invoice_id: 1, id: 1, quantity: 1, unit_price_in_cents: 12345)
    @invoice_item_2 = InvoiceItem.create(item_id: 1, invoice_id: 2, id: 2, quantity: 1, unit_price_in_cents: 12345)
